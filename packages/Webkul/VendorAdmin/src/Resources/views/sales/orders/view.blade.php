    ...
    <div class="content full-page">
        ...
        <div class="page-header">
            ...
            <div class="page-action">
                @if ($order->canCancel())
                    <a href="{{ route('vendoradmin.sales.orders.cancel', $order->id) }}" class="btn btn-lg btn-primary" v-alert:message="'{{ __('admin::app.sales.orders.cancel-confirm-msg') }}'">
                        {{ __('admin::app.sales.orders.cancel-btn-title') }}
                    </a>
                @endif

                @if ($order->canInvoice())
                    <a href="{{ route('vendoradmin.sales.invoices.create', $order->id) }}" class="btn btn-lg btn-primary">
                        {{ __('admin::app.sales.orders.invoice-btn-title') }}
                    </a>
                @endif

                @if ($order->canRefund())
                    <a href="{{ route('vendoradmin.sales.refunds.create', $order->id) }}" class="btn btn-lg btn-primary">
                        {{ __('admin::app.sales.orders.refund-btn-title') }}
                    </a>
                @endif

                @if ($order->canShip())
                    <a href="{{ route('vendoradmin.sales.shipments.create', $order->id) }}" class="btn btn-lg btn-primary">
                            ...
                            <tbody>
                                ...
                                @foreach ($order->invoices as $invoice)
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="{{ route('vendoradmin.sales.invoices.view', $invoice->id) }}">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($order->shipments as $shipment)
                                        <tr>
                                            ...
                                            <td class="action">
                                                <a href="{{ route('vendoradmin.sales.shipments.view', $shipment->id) }}">
                                                    <i class="icon eye-icon"></i>
                                                </a>
                                            </td>
                                        </tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($order->refunds as $refund)
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="{{ route('vendoradmin.sales.refunds.view', $refund->id) }}">
                                                <i class="icon eye-icon"></i>
                                            </a>
                                        </td>
                                    </tr>

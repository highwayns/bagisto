...
@section('content')
    <div class="content">
        <form method="POST" id="page-form" action="{{ route('vendoradmin.cms.edit', $page->id) }}" @submit.prevent="onSubmit">
    ...
    <script>
        $(document).ready(function () {
            $('#preview').on('click', function(e) {
                ...
                // var url = '{{ route('vendoradmin.cms.preview', $page->id) }}' + '?' + form;
                var url = '{{ route('vendoradmin.cms.preview', $page->id) }}';
            ...
            $('#channel-switcher, #locale-switcher').on('change', function (e) {
                ...
                window.location.href = "{{ route('vendoradmin.cms.edit', $page->id)  }}" + query;
            });

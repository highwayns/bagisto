...
@section('content')
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-action">
                ...
                <a href="{{ route('vendoradmin.tax-rates.show') }}" class="btn btn-lg btn-primary">
    ...
    <modal id="uploadDataGrid" :is-open="modalIds.uploadDataGrid">
        ...
        <div slot="body">
            ...
            <form method="POST" action="{{ route('vendoradmin.tax-rates.import') }}" enctype="multipart/form-data" @submit.prevent="onSubmit">
                @csrf()

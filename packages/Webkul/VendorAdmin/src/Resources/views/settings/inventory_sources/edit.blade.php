...
@section('content')
    <div class="content">
        ...
        <form method="POST" action="{{ route('vendoradmin.inventory_sources.update', $inventorySource->id) }}" @submit.prevent="onSubmit">
                ...
                <div class="form-container">
                    ...
                    <accordian :title="'{{ __('admin::app.settings.inventory_sources.address') }}'" :active="true">
                        <div slot="body">
                            ...
                            '@include ('vendoradmin::customers.country-state', ['countryCode' => old('country') ?? $inventorySource->country, 'stateCode' => old('state') ?? $inventorySource->state])

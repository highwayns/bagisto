...
Route::group(['middleware' => ['web']], function () {
    Route::prefix('vendoradmin')->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::post('customers/delete/{id}', 'Webkul\VendorAdmin\Http\Controllers\Customer\CustomerController@destroy')->name('admin.customer.delete');

            Route::post('customers/masssdelete', 'Webkul\VendorAdmin\Http\Controllers\Customer\CustomerController@massDestroy')->name('admin.customer.mass-delete');

            Route::post('customers/masssupdate', 'Webkul\VendorAdmin\Http\Controllers\Customer\CustomerController@massUpdate')->name('admin.customer.mass-update');
            ...
            Route::post('groups/delete/{id}', 'Webkul\VendorAdmin\Http\Controllers\Customer\CustomerGroupController@destroy')->name('admin.groups.delete');
            ...
            //DataGrid Export
            Route::post('admin/export', 'Webkul\VendorAdmin\Http\Controllers\ExportController@export')->name('admin.datagrid.export');
            ...
            Route::prefix('cms')->group(function () {
                ...
                Route::get('preview/{url_key}', 'Webkul\CMS\Http\Controllers\VendorAdmin\PageController@preview')->name('admin.cms.preview');

...
@section('content-wrapper')
    <div class="content full-page">
        <form method="POST" action="{{ route('agentadmin.sales.refunds.store', $order->id) }}" @submit.prevent="onSubmit">
            @csrf()
        ...
        Vue.component('refund-items', {
            ...
            methods: {
                updateQty: function() {
                    ...
                    this.$http.post("{{ route('agentadmin.sales.refunds.update_qty', $order->id) }}", this.refund.items)

...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('agentadmin.tax-rates.update', $taxRate->id) }}" @submit.prevent="onSubmit">
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    '@include ('agentadmin::customers.country-state', ['countryCode' => old('country') ?? $taxRate->country, 'stateCode' => old('state') ?? $taxRate->state])

    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-action">
                <a href="{{ route('agentadmin.exchange_rates.create') }}" class="btn btn-lg btn-primary">
                ...
                {{-- <a href="{{ route('agentadmin.exchange_rates.update-rates', $defaultService) }}" class="btn btn-lg btn-primary">

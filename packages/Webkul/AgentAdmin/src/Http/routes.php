...
Route::group(['middleware' => ['web']], function () {
    Route::prefix('agentadmin')->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::post('customers/delete/{id}', 'Webkul\AgentAdmin\Http\Controllers\Customer\CustomerController@destroy')->name('admin.customer.delete');

            Route::post('customers/masssdelete', 'Webkul\AgentAdmin\Http\Controllers\Customer\CustomerController@massDestroy')->name('admin.customer.mass-delete');

            Route::post('customers/masssupdate', 'Webkul\AgentAdmin\Http\Controllers\Customer\CustomerController@massUpdate')->name('admin.customer.mass-update');
            ...
            Route::post('groups/delete/{id}', 'Webkul\AgentAdmin\Http\Controllers\Customer\CustomerGroupController@destroy')->name('admin.groups.delete');
            ...
            //DataGrid Export
            Route::post('admin/export', 'Webkul\AgentAdmin\Http\Controllers\ExportController@export')->name('admin.datagrid.export');
